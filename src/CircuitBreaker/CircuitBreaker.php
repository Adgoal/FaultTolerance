...
class CircuitBreaker implements CircuitBreakerInterface
{
    ...
    private const DEFAULT_CRITICAL_FAILURES = 6;
     ...
     * @var int
     */
    private $defaultCriticalFailures;
     ...
     * @param int    $failures
     */
    private function setFailures(string $serviceName, int $failures): void
    {
