...
class QueueFaultTolerantConsumer implements QueueConsumerInterface
{
    ...
    private const CONTEXT_QUEUE_CONTEXT_PRIVATE_PROPERTY_NAME = 'interopContext';
    ...
    {
        /** @var Context $context */
        $context = $this->getPrivate($this->originalQueueConsumer, self::CONTEXT_QUEUE_CONTEXT_PRIVATE_PROPERTY_NAME)();
        $context->close();
