...
namespace AdgoalCommon\FaultTolerance\Saga;

use AdgoalCommon\Base\Domain\Exception\LoggerException;
use AdgoalCommon\Base\Utils\LoggerTrait;
use AdgoalCommon\FaultTolerance\Saga\Exception\SagaNotFoundException;
...
class SagaFallResistant
{
    ...
    /**
     * Saga states storage repository.
     *
     ...
     */
    private $sagaManagerEventListener;
    ...
    public function __construct(
        RepositoryInterface $sagaRepository,
        EventStore $eventStore,
        MultipleSagaManager $sagaManagerEventListener
    ) {
        $this->sagaRepository = $sagaRepository;
        $this->eventStore = $eventStore;
        $this->sagaManagerEventListener = $sagaManagerEventListener;
    }
